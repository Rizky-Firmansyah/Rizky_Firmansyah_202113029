				...
				<div class="table-image">
					<table class="tablebox">
						...
						<tbody>
							...
							<tr>
								<td><?php esc_html_e('Slider Settings', 'product-comparison-woocommerce'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('Number of Slides', 'product-comparison-woocommerce'); ?></td>
								<td class="table-img"><?php esc_html_e('4', 'product-comparison-woocommerce'); ?></td>
							...
							<tr>
								...
								<td class="table-img"><?php esc_html_e('6', 'product-comparison-woocommerce'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr class="odd">
								<td><?php esc_html_e('Page Templates & Layout', 'product-comparison-woocommerce'); ?></td>
								<td class="table-img">0</td>
								<td class="table-img"><?php esc_html_e('2(Left/Right Sidebar)', 'product-comparison-woocommerce'); ?></td>
							</tr>
							<tr>
