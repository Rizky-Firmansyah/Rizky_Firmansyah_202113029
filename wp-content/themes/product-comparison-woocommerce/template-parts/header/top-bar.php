      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 align-self-center text-lg-end text-md-start text-center">
          <?php if(get_theme_mod('product_comparison_woocommerce_phone_number') != ''){ ?>
            <span class="phone-number me-3 me-md-0 md-lg-0"><span class="calling-text"><i class="fas fa-mobile-alt me-2"></i></span><a href="tel:<?php echo esc_attr( get_theme_mod('product_comparison_woocommerce_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('product_comparison_woocommerce_phone_number',''));?></a></span>
          <?php }?>
