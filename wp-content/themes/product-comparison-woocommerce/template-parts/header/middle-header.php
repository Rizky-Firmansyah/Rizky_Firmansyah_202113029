		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-3 col-6 py-3 py-lg-0 py-md-0 align-self-center myaccount text-lg-end text-md-end text-end">
				<?php if ( is_user_logged_in() ) { ?>
	              <a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>"><i class="fas fa-sign-in-alt mx-2"></i><?php esc_html_e('Login','product-comparison-woocommerce'); ?><span class="screen-reader-text"><?php esc_html_e( 'Login','product-comparison-woocommerce' );?></span></a>
	            <?php } ?>
			</div>
			<div class="col-lg-2 col-md-3 col-6 py-3 py-lg-0 py-md-0 align-self-center search-box-sec text-lg-end text-md-end text-start">
                <?php if( get_theme_mod( 'product_comparison_woocommerce_header_search',true) == 1) { ?>
		          	<div class="search-box">
			            <span><a href="#"><i class='fas fa-search mx-2'></i><?php esc_html_e('Search','product-comparison-woocommerce'); ?></a></span>
		          	</div>
		        <?php }?>
