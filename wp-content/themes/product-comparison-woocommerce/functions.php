...
function product_comparison_woocommerce_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'product-comparison-woocommerce') {
		wp_redirect(admin_url('themes.php?page=product_comparison_woocommerce_guide'));
	}
}
endif;
...
define('PRODUCT_COMPARISON_WOOCOMMERCE_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-product-comparison-woocommerce/','product-comparison-woocommerce'));
...
define('PRODUCT_COMPARISON_WOOCOMMERCE_PRO_DOC',__('https://www.vwthemesdemo.com/docs/product-comparison-woocommerce-pro/','product-comparison-woocommerce'));
